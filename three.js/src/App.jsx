...
export default function App() {
  ...
  const handleScroll = useCallback(() => {
    ...
    setHeroVisible(progress < 0.03)
    setOutroVisible(progress > 0.88)
  }, [])
  ...
  return (
    <>
      ...
      <div className="canvas-wrapper">
        <Canvas
          camera={{ position: [0, 0, 8], fov: 60, near: 0.1, far: 300 }}
          dpr={[1, 2]}
      ...
      <div className="scroll-container">
        {/* Hero Overlay */}
        <div className={`hero-overlay ${heroVisible ? '' : 'hidden'}`}>
          <h1 className="hero-title">Shiwang's Universe</h1>
        ...
        {/* Outro Overlay — Social Links */}
        <div className={`outro-overlay ${outroVisible ? 'visible' : ''}`}>
      ...
      <button className="terminal-toggle-btn" onClick={() => setIsTerminalOpen(true)} title="Open Terminal">
        &gt;_
      </button>
